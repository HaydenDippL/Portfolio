    ...
    return <>
        ...
        <div className='dark left'>
            ...
            <div className='hbox mega-margin'>
                ...
                <img src={BakkeScheduleLedger} className='desktop-screenshot'/>
            </div>
            <div className='hbox mega-margin'>
                <div className='invisible-card left'>
                    <h2 className='large-text medium-margin'>The Idea</h2>
                    <p>I wanted to create a website that was <b>mobile friendly</b> and <b>easy to read</b>. The idea I ultimately landed on was to create a visual schedule, similar to google calendar with the courts at each gym.</p>
                </div>
            ...
            <div className='hbox mega-margin'>
                <div className='invisible-card left'>
                    ...
                    <p className='large-margin'>The website is a vite react app hosted on DigitalOceans.com with a domain name from DreamHost.com. The website interacts with a backend to get the dialy schedules from the recwell API. These schedules are memoized serverside daily, as to not overwhelm the recwell API. Additionally, the backend logs requests to track our backend calls. </p>
                    <h2 className='medium-text small-margin'>What did I learn while making the website?</h2>
                    <ul>
                        <li><b>CSS Psuedo-Elements</b>: I was having serious issues with my syling and lag. Resizing the window would destroy the positioning of the hour mark lines and times themselves. I did some searching and found psuedo-elements `::before` and `::after`.</li>
